...
/* pre:  glut window has been initialized
   post: model has been initialized */ {
	...
	glUniform3f(glGetUniformLocation(ShaderProgram, "planeNormal"), 1.0f, 0.0f, 0.0f); // Set plane normal
	glUniform3f(glGetUniformLocation(ShaderProgram, "planeOffset"), 0.0f, 0.0f, 0.0f); // Set plane offset
	glUniform1f(glGetUniformLocation(ShaderProgram, "detachDistance"), 0.05); // Set detach distance
